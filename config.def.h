...
Shortcut shortcuts[] = {
  ...
  {GDK_MOD1_MASK,      GDK_0,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "0" } },
  {GDK_MOD1_MASK,      GDK_1,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "1" } },
  {GDK_MOD1_MASK,      GDK_2,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "2" } },
  {GDK_MOD1_MASK,      GDK_3,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "3" } },
  {GDK_MOD1_MASK,      GDK_4,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "4" } },
  {GDK_MOD1_MASK,      GDK_5,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "5" } },
  {GDK_MOD1_MASK,      GDK_6,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "6" } },
  {GDK_MOD1_MASK,      GDK_7,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "7" } },
  {GDK_MOD1_MASK,      GDK_8,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "8" } },
  {GDK_MOD1_MASK,      GDK_9,             sc_nav_tabs,          NORMAL,       { SPECIFIC,           "9" } },
...
BufferCommand buffer_commands[] = {
  ...
  {"^Ml$",         bcmd_move_tab,          { NEXT,              NULL } },
  {"^Mh$",         bcmd_move_tab,          { PREVIOUS,          NULL } },
  {"^[0-9]+M$",    bcmd_move_tab,          { SPECIFIC,          NULL } },
  {"^[0-9]*H$",    bcmd_nav_history,       { PREVIOUS,          NULL } },
  {"^[0-9]*L$",    bcmd_nav_history,       { NEXT,              NULL } },
